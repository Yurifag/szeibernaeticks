...
public class ModWorldGenerator implements IWorldGenerator {
    private WorldGenerator generate_ore_copper;
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        case -1:
            break;
        case 0:
            this.generate_ore_copper = new WorldGenMinable(ModBlocks.ore_copper.getDefaultState(), 8);
            this.runGenerator(generate_ore_copper, world, random, chunkX, chunkZ, 20, 0, 64);
            break;
        case 1:
            break;
        }
