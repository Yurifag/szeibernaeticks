...
public class SzeibernaetickCapabilityStorage implements IStorage<ISzeibernaetickStorageCapability> {
	
	@Override
	public void readNBT(Capability<ISzeibernaetickStorageCapability> capability,
			ISzeibernaetickStorageCapability instance, EnumFacing side, NBTBase nbt) {
	...
	@Override
	public NBTBase writeNBT(Capability<ISzeibernaetickStorageCapability> capability,
			ISzeibernaetickStorageCapability instance, EnumFacing side) {
