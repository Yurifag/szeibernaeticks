...
public interface ISzeibernaetickStorageCapability {
  ...
  /**
   * Returns the {@code ItemStack} of the given {@code ISzeibernaetick}, or null
  ...
  /**
   * Removes the given {@code ISzeibernaetick}, if it is installed, and returns
   * its ItemStack.
   *
   * @param name
   *          The {@code ISzeibernaetick} to remove.
   * @return A copy of the ItemStack of the removed ISzeibernaetick, or null if
   *         it wasn't installed.
   */
