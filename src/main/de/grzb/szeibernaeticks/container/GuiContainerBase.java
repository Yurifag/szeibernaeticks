...
public abstract class GuiContainerBase extends ContainerBase {
    ...
    public static final int PLAYER_MAIN_INVENTORY_HEIGHT = 3
            * (ITEM_SLOT_BORDER_WIDTH + ITEM_SLOT_INNER_WIDTH + ITEM_SLOT_BORDER_WIDTH);
     ...
     */
    public GuiContainerBase(IInventory playerInventory, TileEntityGuiContainerBase tileEntityGuiContainer,
            int innerGuiHeight) {
