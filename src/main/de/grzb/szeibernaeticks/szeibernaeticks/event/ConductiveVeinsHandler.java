...
public class ConductiveVeinsHandler implements ISzeibernaetickEventHandler {
    ...
    public void onSzeibernaetickInstalled(SzeibernaetickInstalledEvent e) {
        Log.log("[ConVeinsHandler] SzeiberVeins checking Installation!", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER);

        // If these veins were just installed
        if(e.installedSzeibernaetick instanceof ConductiveVeinsCapability) {
            Log.log("[ConVeinsHandler] SzeiberVeins were installed.", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER);
            ...
            if(e.armoury.getSzeibernaetick(ConductiveVeinsCapability.class) != null) {
                Log.log("[ConVeinsHandler] Something else was installed and SzeiberVeins exist.", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER);
                // If they are, register the newly installed Szeibernaetick.
                ((ConductiveVeinsCapability) e.armoury.getSzeibernaetick(ConductiveVeinsCapability.class)).register(e.installedSzeibernaetick);
            }
        }
    }
    ...
    public void onEnergyConsumptionEvent(EnergyConsumptionEvent e) {
        Log.log("[ConVeinsHandler] An EnergyConsumptionEvent happened", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER, LogType.SPAMMY);
        IArmouryCapability armoury = e.getEntity().getCapability(ArmouryProvider.ARMOURY_CAP, null);
        ConductiveVeinsCapability veins = (ConductiveVeinsCapability) armoury.getSzeibernaetick(ConductiveVeinsCapability.class);
        if(veins != null) {
            Log.log("[ConVeinsHandler] An EnergyConsumptionEvent is being handled.", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER, LogType.SPAMMY);
    ...
    public void onEnergyProductionEvent(EnergyProductionEvent e) {
        Log.log("[ConVeinsHandler] An EnergyProductionEvent happened", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER, LogType.SPAMMY);
        IArmouryCapability armoury = e.getEntity().getCapability(ArmouryProvider.ARMOURY_CAP, null);
        ConductiveVeinsCapability veins = (ConductiveVeinsCapability) armoury.getSzeibernaetick(ConductiveVeinsCapability.class);
        if(veins != null) {
            Log.log("[ConVeinsHandler] An EnergyProductionEvent is being handled.", LogType.DEBUG, LogType.SZEIBER_ENERGY, LogType.SZEIBER_HANDLER, LogType.SPAMMY);
